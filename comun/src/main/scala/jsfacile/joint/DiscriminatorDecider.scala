 ...
 * The [[jsfacile.joint.discriminatorField]] annotation has precedence over this decision, so this type-class has effect only on types that are not annotated with said annotation..
 * */
